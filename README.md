...
* __Move Nodes:__ Nodes can be moved around by clicking and dragging with links following.

<p align="center"><img src="readmeFiles/moveDemo.gif?raw=true" /></p>
<p align="center">click and drag to move nodes</p>

* __Routing tables:__ Each node has a routing tables. These can be toggled by clicking on the node without dragging.
...
* __Link Delays:__ Link delays can be changed by clicking on them. delays are capped at three characters. These changes instantly appear in routing tables of neighboring nodes.
